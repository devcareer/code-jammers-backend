...
router.get("/auth/google/signup", passport.authenticate("googleSignUp", {scope: ["profile", "email"],}));
router.get("/auth/google/signin", passport.authenticate("googleSignIn", {scope: ["profile", "email"],}));
